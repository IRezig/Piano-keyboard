...
export function ConnectMidi({
  ...
  return (
    <>
      ...
      <select
        className="appearance-none rounded border border-gray-400 bg-zinc-700 px-3 py-2 py-[2px] leading-tight text-zinc-200 focus:border-blue-500 focus:outline-none"
